    ...
    <div id="show-product" class="content scaffold-show" role="main">
        ...
        <ol class="property-list product">
            ...
            <g:if test="${productInstance?.description}">
                <li class="fieldcontain">
                    ...
                    <span class="property-value" aria-labelledby="description-label"><g:fieldValue
                            bean="${productInstance}" field="description"/></span>
            ...
            <g:if test="${productInstance?.shortDescription}">
                <li class="fieldcontain">
                    <span id="shortDescription-label" class="property-label"><g:message
                            code="product.shortDescription.label" default="Short Description"/></span>
                    
                    <span class="property-value" aria-labelledby="shortDescription-label"><g:fieldValue
                            bean="${productInstance}" field="shortDescription"/></span>
            ...
            <g:if test="${productInstance?.css}">
                <li class="fieldcontain">
                    <span id="css-label" class="property-label"><g:message
                            code="product.css.label" default="Css"/></span>
                    
                    <span class="property-value" aria-labelledby="css-label"><g:fieldValue
                            bean="${productInstance}" field="css"/></span>
            ...
            <g:if test="${productInstance?.store}">
                <li class="fieldcontain">
                    <span id="store-label" class="property-label"><g:message
                            code="product.store.label" default="Store"/></span>
                    
                    <g:each in="${productInstance.store}" var="s">
                        <span class="property-value" aria-labelledby="store-label"><g:link
            ...
            <g:if test="${productInstance?.recipes}">
                <li class="fieldcontain">
                    <span id="recipes-label" class="property-label"><g:message
                            code="product.recipes.label" default="Recipes"/></span>
                    
                    <g:each in="${productInstance.recipes}" var="r">
                        <span class="property-value" aria-labelledby="recipes-label"><g:link
                                controller="recipe" action="show"
            ...
            <g:if test="${productInstance?.images}">
                <li class="fieldcontain">
                    <span id="images-label" class="property-label"><g:message
                            code="product.images.label" default="Images"/></span>
                    
                    <g:each in="${productInstance.images}" var="i">
                        <span class="property-value" aria-labelledby="images-label"><g:link
