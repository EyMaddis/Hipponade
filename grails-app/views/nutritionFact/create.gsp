...
<div class="schnack container">
    ...
    <div id="create-nutritionFact" class="content scaffold-create form-group" role="main">
        ...
        <g:form url="[resource: nutritionFactInstance, action             : 'save']"  role="form" class="form-horizontal">
        <fieldset>
